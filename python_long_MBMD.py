...
sys.path.append('F:/Tracking-Code/MBMD_vot_code/lib')
sys.path.append('F:/Tracking-Code/MBMD_vot_code/lib/slim')
...
class MobileTracker(object):
    def __init__(self, image, region):
        ...
        vggMSaver.restore(self.sess, 'F:/Tracking-Code/MBMD_vot_code/ckpt/VGGM/vggMParams.ckpt')
